...
import { defaultBook, NewBookForm, newBookSchema } from './schemas';
import { FormProps, Grid, Button, Segment, Divider, Icon } from 'semantic-ui-react';
...
const NewBook: React.FC<Props> = ({ onSubmit, onCancel }) => {
  return (
    <Formik
